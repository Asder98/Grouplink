            ...
            <div className={classes.paper}>
                ...
                >
                    ...
                    <FormControl fullWidth variant="outlined" className={classes.submit} >
                        <InputLabel htmlFor="outlined-age-native-simple">Dzień tygodnia</InputLabel>
                        <Select
                            native
                        ...
                        <FormHelperText error={formik.touched.dayOfTheWeek && Boolean(formik.errors.dayOfTheWeek)}>{formik.touched.dayOfTheWeek && formik.errors.dayOfTheWeek}</FormHelperText>
                    </FormControl>
                    <TextField
                        variant="outlined"
                        margin="normal"
                    ...
                    />
                    <FormControl fullWidth variant="outlined" className={classes.submit} >
                        <InputLabel htmlFor="outlined-age-native-simple">Parzystość</InputLabel>
                        <Select
                            native
                            value={formik.values.groupMixingType}
                            onChange={formik.handleChange}
                            error={formik.touched.groupMixingType && Boolean(formik.errors.groupMixingType)}
                            label="Dzień tygodnia"
                            inputProps={{
                        ...
                        <FormHelperText error={formik.touched.groupMixingType && Boolean(formik.errors.groupMixingType)}>{formik.touched.groupMixingType && formik.errors.groupMixingType}</FormHelperText>
                    </FormControl>
                    <TextField
                        variant="outlined"
                        margin="normal"
                        ...
                        onChange={formik.handleChange}
                        error={formik.touched.lecturerName && Boolean(formik.errors.lecturerName)}
                        helperText={formik.touched.lecturerName && formik.errors.lecturerName}
                        autoFocus
                        classes={{
                            root: classes.root,
                        }}
                    ...
                    <TextField
                        ...
                        onChange={formik.handleChange}
                        error={formik.touched.lecturerSurname && Boolean(formik.errors.lecturerSurname)}
                        helperText={formik.touched.lecturerSurname && formik.errors.lecturerSurname}
                        autoFocus
                        classes={{
                            root: classes.root,
                        }}
